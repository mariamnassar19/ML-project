...
try:
    ...
    st.title('Mon Ami Français')
    st.write(
        'This application predicts the difficulty level of French sentences. You can upload a CSV file, input sentences directly, or input long texts such as song lyrics.')

    # Tab layout for file upload, text input, long text input, YouTube videos by difficulty, and feedback
    tab1, tab2, tab3, tab4, tab5 = st.tabs(
        ["Upload CSV", "Input Sentence", "Input Long Text", "YouTube Videos by Difficulty", "Feedback"])
